              ...
              <table className="table-auto w-full border bg-[#1f2937] text-white pb-5">
                <thead>
                  <tr className='bg-blue-950'>
                    <th className="border px-4 py-2 text-left"> <input type="checkbox" /> Name</th>
                ...
                <tbody>
                  <tr className='hover:bg-[#2c3643] cursor-pointer'>
                    ...
                    <td className="border px-4 py-2">alam@gmail.com</td>
                    <td className="border px-4 py-2">9234504642</td>
